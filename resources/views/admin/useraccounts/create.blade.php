    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('admin.useraccounts.store') }}" method="post"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Nama useraccount. Contoh: Useraccount 1, Useraccount 2, Useraccount 3, dsb. Wajib diisi.
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Email useraccount. Contoh: 089688644323, 088268298975, dsb. Wajib diisi.
                                Maksimal 255 karakter.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Email useraccount. Contoh: hdihs1728, bsjaihei1287397, dsb. Wajib diisi.
                                Maksimal 255 karakter.
                            </div>
                        </div>
                    </div>
